...
import GithubLogo from "./../public/assets/icons/github copy.svg";
  ...
  return (
    ...
    >
      <Tilt
        tiltMaxAngleX="10"
        tiltMaxAngleY="10"
        className="bg-bgSecondaryLight p-5 rounded-2xl sm:w-[370px] w-full h-fit min-h-[590px] shadow-project-blue"
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            >
              <GithubLogo className="w-2/3 h-2/3 z-10" style={{ fill: "white", color: "white" }} />
            </div>
          </div>
        </div>

        <div className="mt-5">
          <h3 className="text-ctnPrimaryLight font-bold text-[24px]">
            {name}
          </h3>
          <p className="mt-2 text-ctnSecondaryLight text-[14px]">
    ...
    <section className="relative xl:my-36 md:mx-36 p-8" id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 text-ctnSecondaryLight text-[17px] max-w-3xl leading-[30px]"
          initial="hidden"
          whileInView="show"
          viewport={{ once: true, amount: 0.25 }}
        >
